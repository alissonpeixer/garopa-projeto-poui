...
import { Cliente, ClienteDto, ClienteListaDto } from '../interface/cliente';
...
export class ClienteService {
  ...
  postCliente(body: Cliente): Observable<ClienteDto> {
    const headers = { 'X-PO-Screen-Lock': 'true' };
    return this.httpClient.post<ClienteDto>(`${this.apiUrl}/`, body, {headers});
  }

  putCliente(body: Cliente): Observable<ClienteDto> {
    const headers = { 'X-PO-Screen-Lock': 'true' };
  ...
  getClienteLista(): Observable<ClienteListaDto> {
    return this.httpClient.get<ClienteListaDto>(`${this.apiUrl}/`);
  }
